...
<?php include ("controlador/ccli.php"); ?>
...
<form name="form1" action="home.php?pg=<?php echo $pg; ?>" method="post">
    ...
    <div class="form-group">
        <label class="txtbold">No. Cliente</label>
        <input type="number" class="form-control" name="noidecli" value="<?php if($pr) echo $data1[0]["noidecli"]; ?>" <?php if($pr) echo "readonly"; ?> required />
        <?php
            if ($pr)
    ...
    <div class="form-group">  
        ...
        <input type="text" class="form-control" name="nodoccli" value="<?php if($pr) echo $data1[0]["nodoccli"] ?>" required />
    </div>
    <div class="form-group">  
        <label class="txtbold">Cliente</label>
        <input type="text" class="form-control" name="nomcli" value="<?php if($pr) echo $data1[0]["nomcli"] ?>" required />
    </div>
    <div class="form-group">  
        <label class="txtbold">Direcci&oacute;n</label>
        <input type="text" class="form-control" name="dircli" value="<?php if($pr) echo $data1[0]["dircli"] ?>" required />
    </div>
    <div class="form-group">  
        <label class="txtbold">Tel&eacute;fono</label>
        <input type="number" class="form-control" name="telcli" value="<?php if($pr) echo $data1[0]["telcli"] ?>" />
    </div>
    <div class="form-group">  
        <label class="txtbold">E-mail</label>
        <input type="email" class="form-control" name="emacli" value="<?php if($pr) echo $data1[0]["emacli"] ?>" />
    </div>
    <div class="form-group">  
                ...
                <td>
                    ...
                    <div class="seacrheta">
                        <i class="fa-duotone fa-magnifying-glass busc" title="Buscar"></i>
                            ...
                            <input type="text" class="form-control colinp" name="filtro" value="<?php echo $filtro;?>" placeholder="Nombre Cliente" onChange="this.form.submit();">
                    </div>
                    </form>
                </td>
...
<br>
    <table border=0 cellpadding="5px" align="center" class="table table-hover">
        ...
        <tr>
            <td><strong>No. Cliente: </strong><?php echo $data[$x]['noidecli']; ?><br>
                <strong>No. documento: </strong><?php echo $data[$x]['nodoccli']; ?><br>
                <strong>Nombre Cliente: </strong><?php echo $data[$x]['nomcli']; ?><br>
                <strong>E-mail: </strong><?php echo $data[$x]['emacli'] ?></td>
            <td><strong>Ciudad: </strong><?php echo $data[$x]['nomubi'] ?><br>
                <strong>Direccion: </strong><?php echo $data[$x]['dircli']; ?><br>
                <strong>Telefono: </strong><?php echo $data[$x]['telcli']; ?></td>
            <td align="center">
                <a title="Eliminar Cliente" href="home.php?del=<?php echo $data[$x]['noidecli'] ?>&pg=<?php echo $pg; ?>" onClick="return confirm('¿Desea eliminar?');"><i class='fa-duotone fa-trash fa_tae'></i></a>
                &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                <a title="Actualizar Datos del cliente" href="home.php?pr=<?php echo $data[$x]['noidecli'] ?>&pg=<?php echo $pg; ?>"><i class='fa-duotone fa-pen-to-square fa_taa'></i></a>
            </td>
        </tr>
        <?php } ?>
        <tfoot>
             <tr>
                <th id="esquina3">Cliente</th>
                <th>Direcci&oacute;n</th>
